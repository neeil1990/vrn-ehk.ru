...
<div class="section">
	...
	<div class="bx_section payment_box">
			...
			<div class="bx_block w100 vertical">
				<div class="bx_element">
					...
					<label for="PAY_CURRENT_ACCOUNT" id="PAY_CURRENT_ACCOUNT_LABEL" onclick="changePaySystem('account');" class="<?if($arResult["USER_VALS"]["PAY_CURRENT_ACCOUNT"]=="Y") echo "selected"?>">
						...
						<span class="pay_picture">
							<img <?=My::NewResize($arPaySystem["PSA_LOGOTIP"]["ID"],90,1000,false)?> alt="<?=htmlspecialcharsbx($arPaySystem["NAME"])?>" >
						</span>
								...
								<div class="bx_description">
									...
									<p>
										...
										if (intval($arPaySystem["PRICE"]) > 0)
											...
											echo htmlspecialchars_decode($arPaySystem["DESCRIPTION"]);
										?>
									</p>
								</div>
							</label>
