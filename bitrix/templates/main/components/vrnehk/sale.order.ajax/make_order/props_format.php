			...
			?>
				<div>
					...
					foreach ($arSource as $arProperties)
					{
						...
						{
							$cur_value=$arProperties["VALUE"];
							if($user_vals && (!isset($arProperties["VALUE"]) || empty($arProperties["VALUE"])) && (isset($user_vals[$arProperties["CODE"]]) && !empty($user_vals[$arProperties["CODE"]])))
							{
								$cur_value=htmlspecialchars($user_vals[$arProperties["CODE"]]);
							}?>
							<div class="bx_block r1x3 pt8">
							...
							<div class="bx_block r3x1">	
								<input type="text" maxlength="250" size="<?=$arProperties["SIZE1"]?>" value="<?=$cur_value;?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>">
						...
						elseif ($arProperties["TYPE"] == "LOCATION")
						{
							...
							$cur_value=$value;
							if($user_vals && (!isset($cur_value) || empty($cur_value)) && (isset($user_vals["UF_LOCATION"]) && !empty($user_vals["UF_LOCATION"])))
							{
								$cur_value=$user_vals["UF_LOCATION"];
							}
							?>
							<div class="bx_block r1x3 pt8">
								<?=$arProperties["NAME"]?>
