this.BX = this.BX || {};
(function (exports,main_core,main_core_events,calendar_util,main_popup,calendar_controls,calendar_entry,calendar_sectionmanager) {
	'use strict';
	...
	class CompactEventForm extends main_core_events.EventEmitter {
	  ...
	  getPopupContentCalendar() {
	    this.DOM.wrap = main_core.Tag.render(_t || (_t = _`<div class="calendar-add-popup-wrap">
			...
			</div>`), this.getTitleControl(), this.getColorControl()), this.getSectionControl('textselect'), this.getDateTimeControl(), this.getUserPlannerSelector(), this.getTypeInfoControl(), this.getLocationControl(), this.DOM.remindersOuterWrap = main_core.Tag.render(_t3 || (_t3 = _`
				<div class="calendar-field-block">
	  ...
	  getTitleControl() {
	    this.DOM.titleInput = main_core.Tag.render(_t7 || (_t7 = _`
	  ...
	  getHostControl() {
	    ...
	    this.DOM.hostBar = main_core.Tag.render(_t9 || (_t9 = _`
	  ...
	  getColorControl() {
	    this.DOM.colorSelect = main_core.Tag.render(_t10 || (_t10 = _`<div class="calendar-field calendar-field-select calendar-field-tiny"></div>`));
	  ...
	  getColorControlsLocationView() {
	    this.DOM.colorSelect = main_core.Tag.render(_t11 || (_t11 = _`<div class="calendar-field calendar-field-select calendar-colorpicker-readonly calendar-field-tiny"></div>`));
	    this.colorSelector = new calendar_controls.ColorSelector({
	      wrap: this.DOM.colorSelect,
	      mode: 'view'
	    });
	  ...
	  getSectionControl(mode) {
	    this.DOM.sectionSelectWrap = main_core.Tag.render(_t12 || (_t12 = _`<div class="calendar-field-choice-calendar"></div>`));
	  ...
	  getDateTimeControl() {
	    this.DOM.dateTimeWrap = main_core.Tag.render(_t13 || (_t13 = _`<div class="calendar-field-container calendar-field-container-datetime"></div>`));
	  ...
	  getUserPlannerSelector() {
	    this.DOM.userPlannerSelectorOuterWrap = main_core.Tag.render(_t14 || (_t14 = _`<div>
			...
			${0}
		<div>`), this.DOM.userSelectorWrap = main_core.Tag.render(_t15 || (_t15 = _`
				<div class="calendar-field-block">
				...
				</div>`), main_core.Loc.getMessage('EC_ATTENDEES_MORE'), main_core.Loc.getMessage('EC_SEC_SLIDER_CHANGE')), this.DOM.informWrap = main_core.Tag.render(_t16 || (_t16 = _`
				<div class="calendar-field-container-inform">
					<span class="calendar-field-container-inform-text">${0}</span>
				</div>`), main_core.Loc.getMessage('EC_NOTIFY_OPTION')), this.DOM.plannerOuterWrap = main_core.Tag.render(_t17 || (_t17 = _`
				<div class="calendar-planner-wrapper" style="height: 0">
				</div>`)), this.DOM.hideGuestsWrap = main_core.Tag.render(_t18 || (_t18 = _`
	  ...
	  getLocationControl() {
	    this.DOM.locationWrap = main_core.Tag.render(_t19 || (_t19 = _`<div class="calendar-field-place"></div>`));
	    this.DOM.locationOuterWrap = main_core.Tag.render(_t20 || (_t20 = _`<div class="calendar-field-block">
	  ...
	  createRemindersControl() {
	    this.reminderValues = [];
	    this.DOM.remindersWrap = main_core.Tag.render(_t21 || (_t21 = _`<div class="calendar-text"></div>`));
	  ...
	  getTypeInfoControl() {
	    this.DOM.typeInfoTitle = main_core.Tag.render(_t22 || (_t22 = _`<div class="calendar-field-title"></div>`));
	    this.DOM.typeInfoLink = main_core.Tag.render(_t23 || (_t23 = _`<div class="calendar-field-link"></div>`));
	    this.DOM.typeInfoWrap = main_core.Tag.render(_t24 || (_t24 = _`
	  ...
	  getRRuleInfoControl() {
	    this.DOM.rruleInfo = main_core.Tag.render(_t25 || (_t25 = _`<div class="calendar-text"></div>`));
	    this.DOM.rruleInfoWrap = main_core.Tag.render(_t26 || (_t26 = _`
			<div class="calendar-field-block" style="display: none">
				<div class="calendar-field-title">${0}:</div>
				${0}
			</div>
	  ...
	  getTimezoneInfoControl() {
	    this.DOM.timezoneInfo = main_core.Tag.render(_t27 || (_t27 = _`<div class="calendar-text"></div>`));
	    this.DOM.timezoneInfoWrap = main_core.Tag.render(_t28 || (_t28 = _`
			<div class="calendar-field-block" style="display: none">
				<div class="calendar-field-title">${0}:</div>
				${0}
			</div>
	  ...
	  setFormValues() {
	    const entry = this.entry;
	    const section = this.getCurrentSection();
	    const readOnly = !this.canDo('edit'); // Date time
	    ...
	    if (readOnly) {
	      if (this.entry.getCurrentStatus() === false) {
	        ...
	        this.DOM.titleLabel = this.DOM.titleInput.parentNode.insertBefore(main_core.Tag.render(_t29 || (_t29 = _`<span class="calendar-field calendar-field-string">${0}</span>`), main_core.Text.encode(entry.getName())), this.DOM.titleInput);
	  ...
	  handlePull(params) {
	    var _this$userPlannerSele, _this$userPlannerSele2, _params$fields5;

	    if (this.userPlannerSelector && (_this$userPlannerSele = this.userPlannerSelector) != null && (_this$userPlannerSele2 = _this$userPlannerSele.planner) != null && _this$userPlannerSele2.isShown()) {
...
}((this.BX.Calendar = this.BX.Calendar || {}),BX,BX.Event,BX.Calendar,BX.Main,BX.Calendar.Controls,BX.Calendar,BX.Calendar));
