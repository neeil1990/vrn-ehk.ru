...
$lang = "ru";
WizardServices::IncludeServiceLang("lang_brands.php", $lang);

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/ru/brands_0.xml";
...
$tabs = 'edit1--#--'.GetMessage("PHOENIX_SECTION_1").'--,--'.'ACTIVE--#--'.GetMessage("PHOENIX_SECTION_2").'--,--'.'NAME--#--'.GetMessage("PHOENIX_SECTION_3").'--,--'.'SORT--#--'.GetMessage("PHOENIX_SECTION_4").'--;--'.'';
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/brands/index.php', array("IBLOCK_BRANDS" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/brands/index.php', array("IBLOCK_TYPE" => $iblockType));
