...
if($iblockID != false)
{
	...
	$arFields = Array(
		...
		"EDIT_FILE_BEFORE" => "/bitrix/modules/concept.phoenix/iblock_forms_edit/advantages_before_save.php",
		"EDIT_FILE_AFTER" => "/bitrix/modules/concept.phoenix/iblock_forms_edit/advantages.php"
	);
