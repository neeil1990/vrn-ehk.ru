...
if($iblockID != false)
{
	...
	$arFields = Array(
		...
		"EDIT_FILE_BEFORE" => "/bitrix/modules/concept.phoenix/iblock_forms_edit/faq_before_save.php",
		"EDIT_FILE_AFTER" => "/bitrix/modules/concept.phoenix/iblock_forms_edit/faq.php"
	);
