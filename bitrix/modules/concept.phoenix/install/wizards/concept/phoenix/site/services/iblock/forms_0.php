...
$lang = "ru";
WizardServices::IncludeServiceLang("lang_forms.php", $lang);

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/ru/forms_0.xml";

$iblockCode = "concept_phoenix_forms";
...
$tabs = 'edit1--#--'.GetMessage("PHOENIX_SECTION_1").'--,--'.'SORT--#--'.GetMessage("PHOENIX_SECTION_2").'--,--'.'NAME--#--'.GetMessage("PHOENIX_SECTION_3").'--,--'.'DESCRIPTION--#--'.GetMessage("PHOENIX_SECTION_4").'--;--'.'';
