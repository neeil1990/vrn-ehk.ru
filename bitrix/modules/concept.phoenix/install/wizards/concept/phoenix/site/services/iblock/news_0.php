...
$iblockCode = "concept_phoenix_news";
...
$tabs = 'edit1--#--'.GetMessage("PHOENIX_SECTION_1").'--,--'.'ACTIVE--#--'.GetMessage("PHOENIX_SECTION_2").'--,--'.'UF_PHX_MAIN_MENU--#--'.GetMessage("PHOENIX_SECTION_3").'--,--'.'UF_PHX_MAIN_NW--#--'.GetMessage("PHOENIX_SECTION_4").'--,--'.'NAME--#--'.GetMessage("PHOENIX_SECTION_5").'--,--'.'CODE--#--'.GetMessage("PHOENIX_SECTION_6").'--,--'.'UF_PHX_NW_TMPL--#--'.GetMessage("PHOENIX_SECTION_7").'--,--'.'UF_PHX_NW_T_ID--#--'.GetMessage("PHOENIX_SECTION_8").'--,--'.'SORT--#--'.GetMessage("PHOENIX_SECTION_9").'--,--'.'edit1_csection1--#----'.GetMessage("PHOENIX_SECTION_10").'--,--'.'UF_SIDEMENU_HTML--#--'.GetMessage("PHOENIX_SECTION_11").'--;--'.'cedit1--#--'.GetMessage("PHOENIX_SECTION_12").'--,--'.'PICTURE--#--'.GetMessage("PHOENIX_SECTION_13").'--,--'.'UF_PHX_NW_PRTXT--#--'.GetMessage("PHOENIX_SECTION_14").'--,--'.'UF_PIC_IN_HEAD--#--'.GetMessage("PHOENIX_SECTION_15").'--,--'.'cedit1_csection1--#----'.GetMessage("PHOENIX_SECTION_16").'--,--'.'UF_PHX_MENU_PICT--#--'.GetMessage("PHOENIX_SECTION_17").'--;--'.'edit5--#--SEO--,--'.'UF_PHX_NW_H1--#--H1--,--'.'UF_PHX_NW_TITLE--#--Title--,--'.'UF_PHX_NW_KWORD--#--Keywords--,--'.'UF_PHX_NW_DSCR--#--Description--,--'.'DESCRIPTION--#--'.GetMessage("PHOENIX_SECTION_18").'--,--'.'UF_PHX_TXT_P--#--'.GetMessage("PHOENIX_SECTION_19").'--,--'.'UF_PHX_SEO_TOP--#--'.GetMessage("PHOENIX_SECTION_20").'--;--'.'cedit2--#--'.GetMessage("PHOENIX_SECTION_21").'--,--'.'UF_PHX_BNRS_VIEW--#--'.GetMessage("PHOENIX_SECTION_22").'--,--'.'UF_PHX_NW_BNNRS--#--'.GetMessage("PHOENIX_SECTION_23").'--;--'.'';
