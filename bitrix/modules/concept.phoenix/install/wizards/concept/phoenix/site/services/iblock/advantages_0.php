...
$lang = "ru";
WizardServices::IncludeServiceLang("lang_advantages.php", $lang);

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/ru/advantages_0.xml";

$iblockCode = "concept_phoenix_advantages";
...
$tabs = 'edit1--#--'.GetMessage("PHOENIX_SECTION_1").'--,--'.'ACTIVE--#--'.GetMessage("PHOENIX_SECTION_2").'--,--'.'SORT--#--'.GetMessage("PHOENIX_SECTION_3").'--,--'.'NAME--#--'.GetMessage("PHOENIX_SECTION_4").'--;--'.'';
