...
$lang = "ru";
WizardServices::IncludeServiceLang("lang_regions.php", $lang);

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/ru/regions_0.xml";
...
$tabs = 'edit1--#--'.GetMessage("PHOENIX_SECTION_1").'--,--'.'ACTIVE--#--'.GetMessage("PHOENIX_SECTION_2").'--,--'.'NAME--#--'.GetMessage("PHOENIX_SECTION_3").'--,--'.'SORT--#--'.GetMessage("PHOENIX_SECTION_4").'--,--'.'IBLOCK_SECTION_ID--#--'.GetMessage("PHOENIX_SECTION_5").'--;--'.'';
