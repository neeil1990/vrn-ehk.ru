...
$lang = "ru";
WizardServices::IncludeServiceLang("lang_action.php", $lang);

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/ru/action_0.xml";
...
$tabs = 'edit1--#--'.GetMessage("PHOENIX_SECTION_1").'--,--'.'ACTIVE--#--'.GetMessage("PHOENIX_SECTION_2").'--,--'.'SORT--#--'.GetMessage("PHOENIX_SECTION_3").'--,--'.'NAME--#--'.GetMessage("PHOENIX_SECTION_4").'--,--'.'CODE--#--'.GetMessage("PHOENIX_SECTION_5").'--;--'.'';
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/offers/index.php', array("IBLOCK_OFFERS" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/offers/index.php', array("IBLOCK_TYPE" => $iblockType));
