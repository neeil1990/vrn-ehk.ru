...
class ListLocationsSubregion
{
	...
	static function OnIBlockPropertyBuildList()
	{
		return array(
			'PROPERTY_TYPE' => 'S',
			'USER_TYPE' => 'SConceptPhoenixListLocationsSubregion',
			'DESCRIPTION' => Loc::getMessage('LOCATIONS_SUBREGION_LINK_PROP_PHOENIX_TITLE'),
	...
	static function GetPropertyFieldHtml($arProperty, $value, $strHTMLControlName)
	{
		...
		if(Loader::includeModule('sale'))
		{
			...
			$source = "/bitrix/tools/concept.phoenix/ajax/settings/sublocations.php";
