...
$arOurTabs = array(
	array(
		"DIV" => "edit1",
		"TAB" => GetMessage("IB_FORM_SETTING_CPHX_TAB_BANNER"),
		"ICON" => "iblock_element",
		"TITLE" => GetMessage("IB_FORM_SETTING_CPHX_TAB_BANNER"),
	),
	array(
		"DIV" => "edit2",
	...
	array(
		"DIV" => "edit3",
		"TAB" => GetMessage("IB_FORM_SETTING_CPHX_TAB_PERSONAL"),
		"ICON" => "iblock_element",
		"TITLE" => GetMessage("IB_FORM_SETTING_CPHX_TAB_PERSONAL"),
	),
	array(
		"DIV" => "edit4",
...
$arr["edit1"] = array(
	...
	array(
		"TYPE" => "STRING",
		"NAME" => GetMessage("IB_FORM_SETTING_CPHX_STR_LABEL1"),
		"ID" => "label1",
	),
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_BANNER_TITLE",
	),
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_BANNER_UPTITLE",
	),
	array(
		"TYPE" => "PROPERTY",
	...
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_BANNER_TEXT",
	),
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_BANNER_DESC",
	),
	array(
		"TYPE" => "STRING",
		"NAME" => GetMessage("IB_FORM_SETTING_CPHX_STR_LABEL2"),
		"ID" => "label2",
	),
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_BANNER_BTN_NAME",
	),
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_BANNER_BTN_TYPE",
	),
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_BANNER_BTN_FORM",
	),
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_BANNER_BTN_LAND",
	),
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_BANNER_BTN_MODAL",
	),
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_BANNER_LINK",
	),
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_BANNER_BTN_QUIZ",
	),
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_BANNER_BTN_BLANK",
	),
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_BANNER_ACTION_ALL_WRAP",
	),
);
...
$arr["edit2"] = array(
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_BANNER_COLOR_TEXT",
	),
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "DETAIL_PICTURE",
	...
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_BANNER_USER_BG_COLOR",
	),
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_BANNER_BORDER",
	),
);
...
$arr["edit3"] = array(
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_PERSONAL_SHOW_BANNERS",
	),
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_PERSONAL_BANNERS_FOR_USERS",
	),
	array(
		"TYPE" => "PROPERTY",
		"CODE" => "PROPERTY_PERSONAL_BANNERS_FOR_USER_GROUPS",
	),
);
