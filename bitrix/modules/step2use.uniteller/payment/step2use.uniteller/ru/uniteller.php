...
$MESS['SALE_UNITELLER_USE_FISKAL'] = 'Использовать форму оплаты с фискализацией (Y/N)';
$MESS['SALE_UNITELLER_AUTO_STATUS'] = 'Автоматическое изменение статуса заказа на Оплачен (Y/N)';//ILONA
$MESS['SALE_UNITELLER_INCLUDE_DELIVERY'] = "Включать стоимость доставки в чек";
$MESS['SALE_UNITELLER_USE_FISKAL_DESC'] = 'В запрос на оплату будет добавлен чек.';
$MESS['SALE_UNITELLER_AUTO_STATUS_DESC'] = '';//ILONA
$MESS['SALE_UNITELLER_TAXMODE'] = 'Режим налогообложения, сконфигурированный в ККМ при регистрации (цифрой)';
$MESS['SALE_UNITELLER_TAXMODE_DESC'] = "0 — Общая система налогообложения, 1 — Упрощенная система налогообложения (Доход), 2 — Упрощенная СН (Доход минус Расход), 3 — Единый налог на вмененный доход, 4 — Единый сельскохозяйственный налог, 5 — Патентная система налогообложения";
...
$MESS['SALE_UNITELLER_LINEATTR'] = 'Признак предмета расчета';
$MESS['SALE_UNITELLER_LINEATTR_DESC'] = 'список возможных значений: https://atlant2010.ru/blog/instruktsiya-po-integratsii-uniteller-s-magazinom-na-1s-bitriks/#lineattr';
$MESS['SALE_UNITELLER_PAYATTR'] = 'Признак способа расчета';
$MESS['SALE_UNITELLER_PAYATTR_DESC'] = 'список возможных значений: https://atlant2010.ru/blog/instruktsiya-po-integratsii-uniteller-s-magazinom-na-1s-bitriks/#payattr';
