...
(function (exports,location_google,main_popup,ui_forms,location_core,location_widget,main_core_events,main_core) {
	...
	var Autocomplete = /*#__PURE__*/function (_EventEmitter) {
	  ...
	  babelHelpers.createClass(Autocomplete, [{
	    ...
	    value: function showPrompt(searchPhrase, params) {
	      ...
	      _classPrivateMethodGet$2(this, _showPromptInner, _showPromptInner2).call(this, searchPhrase, params, babelHelpers.classPrivateFieldGet(this, _promptDelay));
	    }
	  }, {
	    key: "closePrompt",
	...
	var _renderPopup2 = function _renderPopup2(bindElement, mapInnerContainer) {
	  ...
	  babelHelpers.classPrivateFieldSet(this, _contentWrapper, main_core.Tag.render(_templateObject2$1(), mapInnerContainer, babelHelpers.classPrivateFieldGet(this, _gallery).render(), babelHelpers.classPrivateFieldGet(this, _mode$1) === location_core.ControlMode.edit ? babelHelpers.classPrivateFieldGet(this, _addressString$1).render({
